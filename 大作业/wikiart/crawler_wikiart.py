...
def url_page(by_genre, i):
    ...
    urls = [[i['title'], 'https://www.wikiart.org' + i['paintingUrl']] for i in jdata['Paintings']]
    return urls
...
def tag_pic(url):
    ...
    lst_key = ['Date', 'Style', 'Theme', 'Genre', 'Media', 'Location', 'Dimensions']
...
if __name__ == '__main__':
    ...
    print('OK')
    # 创建SQL语句
    sql = "INSERT INTO wikiart_test (Name, Date, Style, Theme, Genre, Media, Location, Dimensions, Url)\
